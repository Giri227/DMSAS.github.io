<section class="py-4">
    <div class="container">
        <h3 class="fw-bolder text-center">Search Hospital</h3>
        <center>
        ...
        $('.dt-init').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<a href="./?page=clinic/view_details&id='+(row.id)+'" class="btn btn-primary btn-sm bg-gradient rounded-0 d-flex align-items-center"><span class="material-icons me-2"></span>&nbsp;&nbsp; &nbsp;  View</a>';
                    },
                    width:"10%"
                }
            ],
