...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bolder text-center"><b>Hospital Details</b></h2>
        <hr>
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                <dl class="row">
                    ...
                    <hr class="dark">
                    <dt class="col-3 px-2">Hospital Name</dt>
                    <dd class="col-9 px-2">
                        <div class="lh-1">
                            <?php if(isset($cats)): ?>
                    ...
                    <hr class="dark">
                    <dt class="col-3 px-2">Address</dt>
                    ...
                    <div class="d-flex w-100 justify-content-end">
                        <div class="col-auto me-2">
                            <a href=".?page=clinic/manage_clinic&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary bg-gradient btn-sm rounded-0 d-flex align-items-center"><span class="material-icons"></span> Edit</a>
                        </div>
                        <div class="col-auto">
                            <a href="javascript:void(0)" class="btn btn-danger bg-gradient btn-sm rounded-0 d-flex align-items-center" id="delete_data"><span class="material-icons"></span> Delete</a>
                        </div>
                    </div>
                </dl>
            </div>
