...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bolder text-center"><b><?= isset($id) ? "Add Doctor" : "Add New Doctor" ?></b></h2>
        <hr>
            ...
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                <form action="" id="clinic-form" class="py-3">
                    ...
                    <div class="input-group mb-3 input-group-static is-filled">
                        <label for="category_id" class="form-label">Hospital Name <span class="text-primary">*</span></label>
                    ...
                    <div class="form-group mb-3">
                        <label for="other" class="form-label">Address<span class="text-primary">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="./?page=clinic" class="btn bg-deafult border bg-gradient btn-sm w-25"><span class="material-icons"></span> Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
